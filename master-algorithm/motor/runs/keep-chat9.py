"""Keep-chat9 — ≥30-turn ONE continuous stateful conversation.
...
Patch: talk.py — «mentira 2F» → false-law reject after fib truth.
"""
...
def run_grill(round_name: str = "keep-chat9") -> dict:
    ...
    (RUNS / "keep-chat9.json").write_text(
